<div class="slider">
  ...
  <div class="slides" id="slidesid">
    ...
    <div class="slide efecto_fade">
      <div class="sombra_sobre_banner">
      </div>
      <div class="malla_2_intslide">
        <div class="logo">
          <div class="etiqueta">
            <div class="dib1">
      ...
      <img src="static/banner/b1.png" alt="" class="slide_img">
    </div>
    ...
    <div class="slide efecto_fade">
      ...
      <img src="static/banner/b2.png" alt="" class="slide_img">
    </div>
    ...
    <div class="slide efecto_fade">
      ...
      <img src="static/banner/b3.png" alt="" class="slide_img">
    </div>

  </div>

  <div class="slider_prev negrita tamf_40" id="slider_previd" onclick="cambia_slide(-1)">
    <i class="fa-solid fa-chevron-left"></i>
  </div>
  <div class="slider_next negrita tamf_40" id="slider_nextid" onclick="cambia_slide(1)">
