<div class="footer">
  <div class="malla_3_footer">
      ...
      <div class="malla_1_footer_2">

        <div class="titufoot">
          <p class="tamf_18 negrita beige">Contactanos</p>
        </div>
      ...
      <div class="malla_1_footer_2">
        <div class="titufoot">
          <p class="tamf_18 negrita beige">Mapa del sitio</p>
        </div>
        <div id="parrafosfoot3">
          <a class="tamf_13 blanco elemfooter" href="productos.php">Productos</a>
          <a class="tamf_13 blanco elemfooter" href="nosotros.php">Nosotros</a>
          <a class="tamf_13 blanco elemfooter" href="ofertas.php">Ofertas</a>
          <a class="tamf_13 blanco elemfooter" href="contacto.php">Contacto</a>
        </div>
      </div>
